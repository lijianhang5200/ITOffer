		...
		<div class="head_area">
			...
			<div class="head_user">
				<c:if test="${sessionScope.user != null}">
					<a href="applicant/resume.html" target="_parent">${sessionScope.user.applicant_email }</a>
					<a href="logout.html" target="_parent">退出</a>
				</c:if>
				<c:if test="${sessionScope.user==null}">
					<a href="login.jsp"><span class="type1">登录</span></a>
					<a href="register.jsp"><span class="type2">注册</span></a>
				</c:if>
			</div>
			<div class="clear"></div>
		</div>
