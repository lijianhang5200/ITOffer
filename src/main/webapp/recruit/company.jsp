					...
					<div class="it-post-box tn-border-dashed">
						<div class="it-post-name">
							<div class="tn-helper-right it-post-btn">
								...
								<a class="tn-button-small" href="#"><span class="tn-button-text">申请</span> </a>
							</div>
							<h3><a title=对日Java软件开发工程师 href="job.html" target=_blank>对日Java软件开发工程师</a></h3>
						</div>
						<ul class="it-post">
							<li style="width:300px;">薪资： <span class="it-font-size">2500~4000元/月</span></li>
