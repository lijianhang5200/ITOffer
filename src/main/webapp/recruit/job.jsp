				...
				<div class="it-main">
					<div class="it-ctn-heading">
						<div class="it-title-line">
							<span class="it-hover-text"><a href="#" target="_blank">其它同类职位</a><span style="float:left;margin-right:20px">
					...
					<div class="job">
						...
						<div class="it-post-count">
							<div class="it-com-apply">
								<a href="javascript:void(0)" title="您已经申请过！" class="tn-button it-smallbutton-apply-hover"></a>
							</div>
							<ul class="tn-text-note it-text-part">
								...
								<li class="jobli"><span class="tn-explain-icon"><span class="tn-icon it-icon-people"></span><span class="tn-icon-text">招聘人数 <span class="it-font-cor">40</span> 人</span>
									</span>
								</li>
								<li class="jobli"><span class="tn-explain-icon"><span class="tn-icon it-icon-people"></span><span class="tn-icon-text">申请人数 <span class="it-font-cor">44</span> 人</span>
									</span>
								</li>
							</ul>
						</div>
						...
						<div class="it-post-text">
							...
							<p> <strong><strong>转正工资：济南：</strong>年薪4-5.5万元 按照国家标准缴纳五险一金。</strong>
							</p>
						...
						<div class="btn_bot">
							<a class="tn-button-secondary" href="#" target="_blank"> <span style="color:#1faebc" class="tn-button-text">查看公司信息</span> </a>
							<a title="您已经申请过！" class="tn-button-secondary" href="javascript:void(0)"> <span class="tn-button-text">此职位已经申请</span> </a>
						</div>
					</div>
				</div>
				<div class="job_right">
					<div class="it-listbox">
						...
						<div class="it-listbox-content">
							<ul>
								<li><span class="tn-icon"></span>
									<a title="软件开发工程师" href="#" target="_blank">软件开发工程师</a>
								</li>
								<li><span class="tn-icon"></span>
									<a title=".Net软件开发" href="#" target="_blank">.Net软件开发</a>
								</li>
								<li><span class="tn-icon"></span>
									<a title="移动客户端开发" href="#" target="_blank">移动客户端开发</a>
								</li>
								<li><span class="tn-icon"></span>
									<a title="Java软件开发" href="#" target="_blank">Java软件开发</a>
								</li>
								<li><span class="tn-icon"></span>
									<a title="其他" href="#" target="_blank">其他</a>
								</li>
								<li><span class="tn-icon"></span>
									<a title="IT运维工程师" href="#" target="_blank">IT运维工程师</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="it-listbox">
						...
						<div class="it-listbox-content">
							<ul>
								<li><span class="tn-icon"></span>
									<a title="“锐聘之星”软件设计大赛" href="#" target="_blank ">“锐聘之星”软件设计大赛</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="凌志软件股份有限公司 " href="# " target="_blank ">凌志软件股份有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="北京日立华胜信息系统有限公司 " href="# " target="_blank ">北京日立华胜信息系统有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="宏智科技（苏州）有限公司 " href="# " target="_blank ">宏智科技（苏州）有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="江苏仕德伟网络科技股份有限公司 " href="# " target="_blank ">江苏仕德伟网络科技股份有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="青岛百灵信息科技有限公司 " href="# " target="_blank ">青岛百灵信息科技有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="无锡晟奥软件有限公司 " href="# " target="_blank ">无锡晟奥软件有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="苏州大宇宙信息创造有限公司 " href="# " target="_blank ">苏州大宇宙信息创造有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="青岛拓宇网络科技有限公司 " href="# " target="_blank ">青岛拓宇网络科技有限公司</a>
								</li>
								<li><span class="tn-icon "></span>
									<a title="无锡NTT DATA有限公司 " href="# " target="_blank ">无锡NTT DATA有限公司</a>
								</li>
							</ul>
						</div>
					</div>
