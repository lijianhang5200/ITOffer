	...
	<div class="it-aside-fixed">
		<div id="resumeSavePreview">
			<div class="it-comment-btn">
				<a id="reviewResume" class="tn-button tn-corner-all tn-button-text-only tn-button-preview" href="applicant/resumeView.html" target="_parent" plugin="dialog">
		...
		<div id="resumeFull">
			...
			<div class="it-editdata-list">
				<ul>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#Resume">基本信息</a> <span class="tn-icon it-icon-accept"></span></li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesEducationExperience">
							教育经历</a>
						<span class="tn-icon it-icon-accept"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#WorkExperience">工作经历</a>
						<span class="tn-icon it-icon-accept"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesLanguageAbility">
							语言能力</a>
						<span class="tn-icon it-icon-accept"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesProjectExperience">
							项目经验</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesHonour">获得证书</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesTrainExperience">
							培训经历</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesITTec">IT技能</a>
						<span class="tn-icon it-icon-accept"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesOtherInfo">其他信息</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#Resume">简历照片</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
					<li class="tn-editdata-bg">
						<a class="tn-button-text" href="#ResumesAttachment">简历附件</a>
						<span class="tn-icon it-icon-stop"></span>
					</li>
				</ul>
			</div>
