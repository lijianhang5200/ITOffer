	...
	<body style="background:#f0f9fd;">
		...
		<dl class="leftmenu">
			<dd>
				...
				<ul class="menuson">
					<li><cite></cite>
						<a href="manage/jobApplyList.html" target="rightFrame">职位申请查看</a><i></i></li>
					<li><cite></cite>
						<a href="manage/jobList.html" target="rightFrame">职位管理</a><i></i></li>
					<li><cite></cite>
						<a href="manage/companyList.html" target="rightFrame">企业管理</a><i></i></li>
				</ul>
			</dd>
			<dd>
				...
				<ul class="menuson">
					<li><cite></cite>
						<a href="manage/resumeList.html" target="rightFrame">简历查询</a><i></i></li>
				</ul>
			</dd>
			<dd>
				...
				<ul class="menuson">
					<li><cite></cite>
						<a href="manage/userList.html" target="rightFrame">用户管理</a><i></i></li>
				</ul>
			</dd>
			<dd>
				...
				<ul class="menuson">
					<li><cite></cite>
						<a href="manage/userOnline.html" target="rightFrame">在线用户</a><i></i></li>
				</ul>
			</dd>
			<dd>
